...
{
    [InitializeOnLoad]
    public class VrcLinkingDefinesManager
    {
        static VrcLinkingDefinesManager()
        {
            AddDefinesIfMissing(EditorUserBuildSettings.selectedBuildTargetGroup, new string[] { "VRCLINKING" });
        }
