...
namespace VRCLinkingAPI.Model
{
    ...
    /// GroupLinkedRole
    /// </summary>
    [DataContract(Name = "GroupLinkedRole")]
    public partial class GroupLinkedRole
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupLinkedRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GroupLinkedRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupLinkedRole" /> class.
        /// </summary>
        ...
        public GroupLinkedRole(string id = default(string), string discordRoleId = default(string), string groupRoleId = default(string), GroupAction action = default(GroupAction))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GroupLinkedRole and cannot be null");
            }
            this.Id = id;
            this.Action = action;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupLinkedRole {\n");
