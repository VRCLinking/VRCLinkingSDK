...
namespace VRCLinkingAPI.Model
{
    ...
    /// GuildLinkedRole
    /// </summary>
    [DataContract(Name = "GuildLinkedRole")]
    public partial class GuildLinkedRole
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GuildLinkedRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GuildLinkedRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GuildLinkedRole" /> class.
        /// </summary>
        ...
        public GuildLinkedRole(string id = default(string), string discordRoleId = default(string), string groupRoleId = default(string), GuildAction action = default(GuildAction))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for GuildLinkedRole and cannot be null");
            }
            this.Id = id;
            this.Action = action;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GuildLinkedRole {\n");
