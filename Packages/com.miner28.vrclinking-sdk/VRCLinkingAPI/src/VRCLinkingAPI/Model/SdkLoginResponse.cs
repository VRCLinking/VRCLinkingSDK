...
namespace VRCLinkingAPI.Model
{
    ...
    public partial class SdkLoginResponse
    {
        ...
        public SdkLoginResponse(string id = default(string), string username = default(string), string avatar = default(string), string globalName = default(string), UserRank rank = default(UserRank), string token = default(string))
        {
            ...
            if (token == null)
            {
                throw new ArgumentNullException("token is a required property for SdkLoginResponse and cannot be null");
            }
            this.Token = token;
